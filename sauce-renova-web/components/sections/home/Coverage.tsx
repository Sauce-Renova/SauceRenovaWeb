...
const SpainMap = ({ color = "#78a83f", strokeColor = "#fafad6" }) => (
  <svg viewBox="0 0 300 220" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "100%", maxWidth: 320 }}>
    ...
    <circle cx="180" cy="120" r="5" fill="#0354bf" />
    <path d="M180,115 L180,100" stroke="#0354bf" strokeWidth="2" />
    <circle cx="150" cy="140" r="5" fill="#0354bf" />
    <path d="M150,135 L150,120" stroke="#0354bf" strokeWidth="2" />
    <circle cx="160" cy="110" r="5" fill="#0354bf" />
    <path d="M160,105 L160,90" stroke="#0354bf" strokeWidth="2" />
  </svg>
);
    ...
    <section style={{ background: bg, padding: "80px 24px" }} id="tramites">
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
          <SpainMap
            color={isDark ? "#0354bf" : "#78a83f"}
            strokeColor={isDark ? "#1a2235" : "#fafad6"}
          />
        </div>
        <div>
          <h2 style={{
